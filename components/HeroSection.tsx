  ...
  return (
    <section className="py-20 md:py-32 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center container mx-auto px-6 relative min-h-[calc(100vh-80px)]">
      ...
      <div className="flex flex-col items-start text-left relative z-10 w-full max-w-2xl">
        ...
        {/* Floating rounded square (Matches the instructor's design) */}
        <div className="w-16 h-16 bg-slate-300 dark:bg-[#8B93A5] rounded-[1.2rem] -rotate-12 mb-8 shadow-lg"></div>
        ...
        <h1 className="text-5xl md:text-6xl lg:text-[4.5rem] font-extrabold tracking-tight text-slate-900 dark:text-white mb-6 font-serif leading-[1.1]">
          Hello, my <br className="hidden md:block" /> name's <span className="text-blue-600">Christian</span>.
        </h1>

        <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 mb-10 max-w-lg leading-relaxed font-sans">
          I'm a passionate Software Developer from Cordova, Cebu. Dedicated to building websites, web applications, and custom software that are functional and visually captivating.
        </p>
        ...
        {/* Social Icons (Moved under the buttons so they don't break the right-side image) */}
      ...
      {/* --- RIGHT COLUMN: GLOWING PORTRAIT CARD --- */}
      <div className="flex items-center justify-center lg:justify-end w-full mt-12 lg:mt-0 relative z-10">
        ...
        <div className="relative w-full max-w-[360px] md:max-w-[420px] aspect-[4/5]">
          ...
          <div className="relative h-full w-full rounded-[2.5rem] overflow-hidden bg-slate-100 dark:bg-[#070B1A] border-4 border-slate-200 dark:border-[#10172A] z-10">
            <Image 
              src="/washing.jpg" 
              alt="Christian - Software Developer" 
              fill 
            ...
            {/* Overlay Name Tag inside the image */}
            <div className="absolute bottom-6 left-6 right-6 flex items-center">
              <div className="bg-black/40 backdrop-blur-md border border-white/10 px-4 py-2.5 rounded-2xl flex items-center gap-3">
                ...
                <span className="text-white font-medium tracking-wide">Christian</span>
              </div>
            </div>
